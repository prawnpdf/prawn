...
Prawn::ManualBuilder::Chapter.new do
  ...
  text do
    prose <<~TEXT
      ...
      direction to <code>:rtl</code> automatically changes the default
      alignment to <code>:right</code>.
      ...
      right-to-left languages is easy using the <code>bidi</code> Ruby Gem and
      its <code>render_visual</code> function. See
