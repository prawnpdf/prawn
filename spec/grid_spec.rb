...
describe "A document's grid" do
  ...
  describe 'when a grid is defined' do
    ...
    it 'draws outlines without changing global default colors to grid color' do
      ...
      # Hardcoded default color as I haven't been able to come up with a stable
      # converter between fill_color without lots code.
